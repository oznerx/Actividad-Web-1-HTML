...
describe('CharacterEpisodes', () => {
  ...
  it('should render episodes correctly', () => {
    ...
    character.episode.forEach((episode) => {
      const episodeNumber = episode.replace("https://rickandmortyapi.com/api/episode/", "");
  ...
  it('should format URLs correctly', () => {
    ...
    character.episode.forEach((episode) => {
      const formattedEpisode = episode.replace("https://rickandmortyapi.com/api/episode/", "");
  ...
  it('should have correct button classes and attributes', () => {
    ...
    character.episode.forEach((episode) => {
      ...
      expect(button).toHaveClass('text-gray-500 ml-4 text-xl list-disc transition-colors duration-200 hover:text-sky-300 select-none');
    });
  });
});
